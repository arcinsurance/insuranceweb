                ...
                <form onSubmit={handleSubmit} className="p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[70vh] overflow-y-auto p-2">
                        <div className="md:col-span-2 text-center">
                            <img src={formData.avatarUrl || '/default-avatar.png'} alt="Avatar Preview" className="w-24 h-24 rounded-full mx-auto mb-2 object-cover bg-gray-200" />
             ...
             <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {agents.map(agent => (
                    <div key={agent.npn} className="bg-white rounded-lg shadow p-4 flex flex-col text-center">
                        <img src={agent.avatarUrl || '/default-avatar.png'} alt={agent.name} className="w-20 h-20 rounded-full mx-auto mb-3 object-cover bg-gray-100" />
